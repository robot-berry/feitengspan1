...
set psu_ddr_init_data {
    ...
    # /LPDDR4 devices.
		# PSU_DDRC_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024                                       0x1c9b7

		# ZQ Control Register 1
		#(OFFSET, MASK, VALUE)      (0XFD070184, 0x3FFFFFFFU ,0x0201C9B7U)  */
    mask_write 0XFD070184 0x3FFFFFFF 0x0201C9B7
    ...
    mask_write 0XFD080040 0xFFFFFFFF 0x4B025810
		...
		# PLL Lock Time
		# PSU_DDR_PHY_PTR1_TPLLLOCK                                                       0xea5b
		...
		#(OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0xEA5B1518U)  */
    mask_write 0XFD080044 0xFFFFFFFF 0xEA5B1518

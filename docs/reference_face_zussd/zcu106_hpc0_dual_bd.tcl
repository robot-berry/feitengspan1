...
################################################################
# This is a generated script based on design: zcu106_hpc0_dual
#
...
# source zcu106_hpc0_dual_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set disable_ssd1_pwr [ create_bd_port -dir O -from 0 -to 0 disable_ssd1_pwr ]
  set disable_ssd2_pwr [ create_bd_port -dir O -from 0 -to 0 disable_ssd2_pwr ]
  set io_1a1 [ create_bd_port -dir O -from 0 -to 0 io_1a1 ]
  set io_1a2 [ create_bd_port -dir O -from 0 -to 0 io_1a2 ]
  set io_1a3 [ create_bd_port -dir O -from 0 -to 0 io_1a3 ]
  set io_1a4 [ create_bd_port -dir O -from 0 -to 0 io_1a4 ]
  set io_3a1 [ create_bd_port -dir O -from 0 -to 0 io_3a1 ]
  set io_3a2 [ create_bd_port -dir O -from 0 -to 0 io_3a2 ]
  set io_3a3 [ create_bd_port -dir O -from 0 -to 0 io_3a3 ]
  set io_3a4 [ create_bd_port -dir O -from 0 -to 0 io_3a4 ]
  set io_3a5 [ create_bd_port -dir O -from 0 -to 0 io_3a5 ]
  set io_3a6 [ create_bd_port -dir O -from 0 -to 0 io_3a6 ]
  set io_3a7 [ create_bd_port -dir O -from 0 -to 0 io_3a7 ]
  set io_3a8 [ create_bd_port -dir O -from 0 -to 0 io_3a8 ]
  set io_4a1 [ create_bd_port -dir O -from 0 -to 0 io_4a1 ]
  set io_4a2 [ create_bd_port -dir O -from 0 -to 0 io_4a2 ]
  set io_4a3 [ create_bd_port -dir O -from 0 -to 0 io_4a3 ]
  set io_4a4 [ create_bd_port -dir O -from 0 -to 0 io_4a4 ]
  set io_4a5 [ create_bd_port -dir O -from 0 -to 0 io_4a5 ]
  set io_4a6 [ create_bd_port -dir O -from 0 -to 0 io_4a6 ]
  set io_4a7 [ create_bd_port -dir O -from 0 -to 0 io_4a7 ]
  set io_4a8 [ create_bd_port -dir O -from 0 -to 0 io_4a8 ]
  ...
  set perst_1 [ create_bd_port -dir O -from 0 -to 0 -type rst perst_1 ]
  set sw_0 [ create_bd_port -dir I -from 0 -to 0 sw_0 ]
  set sw_1 [ create_bd_port -dir I -from 0 -to 0 sw_1 ]
  set sw_2 [ create_bd_port -dir I -from 0 -to 0 sw_2 ]
  set sw_3 [ create_bd_port -dir I -from 0 -to 0 sw_3 ]
  set sw_4 [ create_bd_port -dir I -from 0 -to 0 sw_4 ]
  set sw_5 [ create_bd_port -dir I -from 0 -to 0 sw_5 ]
  set sw_6 [ create_bd_port -dir I -from 0 -to 0 sw_6 ]
  set sw_7 [ create_bd_port -dir I -from 0 -to 0 sw_7 ]
  ...
  # Create instance: const_dis_ssd1_pwr, and set properties
  set const_dis_ssd1_pwr [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 const_dis_ssd1_pwr ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
 ] $const_dis_ssd1_pwr
  ...
  set ref_clk_1_buf [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf:2.1 ref_clk_1_buf ]
  set_property -dict [ list \
   CONFIG.C_BUF_TYPE {IBUFDSGTE} \
 ] $ref_clk_1_buf
  ...
  set rst_pcie_1_axi_aclk [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_pcie_1_axi_aclk ]

  # Create instance: rst_ps8_0_99M, and set properties
  set rst_ps8_0_99M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_99M ]

  # Create instance: sw_0, and set properties
  set sw_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:vio:3.0 sw_0 ]
  set_property -dict [ list \
   CONFIG.C_NUM_PROBE_IN {8} \
   CONFIG.C_NUM_PROBE_OUT {28} \
 ] $sw_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.pl_link_cap_max_link_width {X4} \
   CONFIG.plltype {QPLL1} \
   CONFIG.select_quad {GTY_Quad_131} \
   CONFIG.sys_reset_polarity {ACTIVE_LOW} \
   CONFIG.type1_membase_memlimit_enable {Enabled} \
   CONFIG.type1_prefetchable_membase_memlimit {64bit_Enabled} \
   CONFIG.xdma_axilite_slave {true} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#I2C 0#I2C 0#GPIO0 MIO#GPIO0 MIO#UART 0#UART 0#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#CAN 1#CAN 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#PMU GPO 0#PMU GPO 1#PMU GPO 2#PMU GPO 3#PMU GPO 4#PMU GPO 5#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#gpio0[6]#n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#gpio0[13]#scl_out#sda_out#gpio0[16]#gpio0[17]#rxd#txd#gpio0[20]#gpio0[21]#gpio0[22]#gpio0[23]#phy_tx#phy_rx#gpio1[26]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpio1[31]#gpo[0]#gpo[1]#gpo[2]#gpo[3]#gpo[4]#gpo[5]#gpio1[38]#gpio1[39]#gpio1[40]#gpio1[41]#gpio1[42]#gpio1[43]#sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
  ...
  connect_bd_intf_net -intf_net diff_clock_rtl_1_1 [get_bd_intf_ports diff_clock_rtl_1] [get_bd_intf_pins ddr4_1/C0_SYS_CLK]
  ...
  connect_bd_intf_net -intf_net periph_intercon_0_M02_AXI [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI] [get_bd_intf_pins periph_intercon_0/M02_AXI]
  connect_bd_intf_net -intf_net periph_intercon_0_M03_AXI [get_bd_intf_pins ddr4_1/C0_DDR4_S_AXI] [get_bd_intf_pins periph_intercon_0/M03_AXI]
  connect_bd_intf_net -intf_net periph_intercon_1_M00_AXI [get_bd_intf_pins periph_intercon_1/M00_AXI] [get_bd_intf_pins xdma_1/S_AXI_B]
  connect_bd_intf_net -intf_net periph_intercon_1_M01_AXI [get_bd_intf_pins periph_intercon_1/M01_AXI] [get_bd_intf_pins xdma_1/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net xdma_1_M_AXI_B [get_bd_intf_pins axi_mem_intercon_1/S00_AXI] [get_bd_intf_pins xdma_1/M_AXI_B]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins periph_intercon_1/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  ...
  connect_bd_net -net const_dis_ssd2_pwr1_dout [get_bd_ports disable_ssd1_pwr] [get_bd_pins const_dis_ssd1_pwr/dout]
  connect_bd_net -net const_dis_ssd2_pwr_dout [get_bd_ports disable_ssd2_pwr] [get_bd_pins const_dis_ssd2_pwr/dout]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins periph_intercon_0/M02_ACLK] [get_bd_pins rst_ddr4_0_333M/slowest_sync_clk]
  ...
  connect_bd_net -net ddr4_1_c0_ddr4_ui_clk [get_bd_pins ddr4_1/c0_ddr4_ui_clk] [get_bd_pins periph_intercon_0/M03_ACLK] [get_bd_pins rst_ddr4_1_333M/slowest_sync_clk]
  ...
  connect_bd_net -net probe_in0_0_1 [get_bd_ports sw_0] [get_bd_pins ddr4_0/sys_rst] [get_bd_pins sw_0/probe_in0]
  connect_bd_net -net probe_in1_0_1 [get_bd_ports sw_1] [get_bd_pins ddr4_1/sys_rst] [get_bd_pins sw_0/probe_in1]
  connect_bd_net -net probe_in2_0_1 [get_bd_ports sw_2] [get_bd_pins sw_0/probe_in2]
  connect_bd_net -net probe_in3_0_1 [get_bd_ports sw_3] [get_bd_pins sw_0/probe_in3]
  connect_bd_net -net probe_in4_0_1 [get_bd_ports sw_4] [get_bd_pins sw_0/probe_in4]
  connect_bd_net -net probe_in5_0_1 [get_bd_ports sw_5] [get_bd_pins sw_0/probe_in5]
  connect_bd_net -net probe_in6_0_1 [get_bd_ports sw_6] [get_bd_pins sw_0/probe_in6]
  connect_bd_net -net probe_in7_0_1 [get_bd_ports sw_7] [get_bd_pins sw_0/probe_in7]
  ...
  connect_bd_net -net rst_ddr4_0_333M_peripheral_aresetn [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins periph_intercon_0/M02_ARESETN] [get_bd_pins rst_ddr4_0_333M/peripheral_aresetn]
  connect_bd_net -net rst_ddr4_1_333M_peripheral_aresetn [get_bd_pins ddr4_1/c0_ddr4_aresetn] [get_bd_pins periph_intercon_0/M03_ARESETN] [get_bd_pins rst_ddr4_1_333M/peripheral_aresetn]
  ...
  connect_bd_net -net rst_pcie_1_axi_aclk_peripheral_reset [get_bd_ports perst_1] [get_bd_pins rst_pcie_1_axi_aclk/peripheral_reset]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins periph_intercon_0/S00_ARESETN] [get_bd_pins periph_intercon_1/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_ports led_0] [get_bd_pins sw_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_ports led_1] [get_bd_pins sw_0/probe_out1]
  connect_bd_net -net vio_0_probe_out2 [get_bd_ports led_2] [get_bd_pins sw_0/probe_out2]
  connect_bd_net -net vio_0_probe_out3 [get_bd_ports led_3] [get_bd_pins sw_0/probe_out3]
  connect_bd_net -net vio_0_probe_out4 [get_bd_ports led_4] [get_bd_pins sw_0/probe_out4]
  connect_bd_net -net vio_0_probe_out5 [get_bd_ports led_5] [get_bd_pins sw_0/probe_out5]
  connect_bd_net -net vio_0_probe_out6 [get_bd_ports led_6] [get_bd_pins sw_0/probe_out6]
  connect_bd_net -net vio_0_probe_out7 [get_bd_ports led_7] [get_bd_pins sw_0/probe_out7]
  connect_bd_net -net vio_0_probe_out8 [get_bd_ports io_1a1] [get_bd_pins sw_0/probe_out8]
  connect_bd_net -net vio_0_probe_out9 [get_bd_ports io_1a2] [get_bd_pins sw_0/probe_out9]
  connect_bd_net -net vio_0_probe_out10 [get_bd_ports io_1a3] [get_bd_pins sw_0/probe_out10]
  connect_bd_net -net vio_0_probe_out11 [get_bd_ports io_1a4] [get_bd_pins sw_0/probe_out11]
  connect_bd_net -net vio_0_probe_out12 [get_bd_ports io_3a1] [get_bd_pins sw_0/probe_out12]
  connect_bd_net -net vio_0_probe_out13 [get_bd_ports io_3a2] [get_bd_pins sw_0/probe_out13]
  connect_bd_net -net vio_0_probe_out14 [get_bd_ports io_3a3] [get_bd_pins sw_0/probe_out14]
  connect_bd_net -net vio_0_probe_out15 [get_bd_ports io_3a4] [get_bd_pins sw_0/probe_out15]
  connect_bd_net -net vio_0_probe_out16 [get_bd_ports io_3a5] [get_bd_pins sw_0/probe_out16]
  connect_bd_net -net vio_0_probe_out17 [get_bd_ports io_3a6] [get_bd_pins sw_0/probe_out17]
  connect_bd_net -net vio_0_probe_out18 [get_bd_ports io_3a7] [get_bd_pins sw_0/probe_out18]
  connect_bd_net -net vio_0_probe_out19 [get_bd_ports io_3a8] [get_bd_pins sw_0/probe_out19]
  connect_bd_net -net vio_0_probe_out20 [get_bd_ports io_4a1] [get_bd_pins sw_0/probe_out20]
  connect_bd_net -net vio_0_probe_out21 [get_bd_ports io_4a2] [get_bd_pins sw_0/probe_out21]
  connect_bd_net -net vio_0_probe_out22 [get_bd_ports io_4a3] [get_bd_pins sw_0/probe_out22]
  connect_bd_net -net vio_0_probe_out23 [get_bd_ports io_4a4] [get_bd_pins sw_0/probe_out23]
  connect_bd_net -net vio_0_probe_out24 [get_bd_ports io_4a5] [get_bd_pins sw_0/probe_out24]
  connect_bd_net -net vio_0_probe_out25 [get_bd_ports io_4a6] [get_bd_pins sw_0/probe_out25]
  connect_bd_net -net vio_0_probe_out26 [get_bd_ports io_4a7] [get_bd_pins sw_0/probe_out26]
  connect_bd_net -net vio_0_probe_out27 [get_bd_ports io_4a8] [get_bd_pins sw_0/probe_out27]
  ...
  connect_bd_net -net xdma_0_interrupt_out_msi_vec0to31 [get_bd_pins concat_interrupts/In2] [get_bd_pins xdma_0/interrupt_out_msi_vec0to31]
  connect_bd_net -net xdma_0_interrupt_out_msi_vec32to63 [get_bd_pins concat_interrupts/In3] [get_bd_pins xdma_0/interrupt_out_msi_vec32to63]
  connect_bd_net -net xdma_1_axi_aclk [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins periph_intercon_1/ACLK] [get_bd_pins periph_intercon_1/M00_ACLK] [get_bd_pins periph_intercon_1/M01_ACLK] [get_bd_pins rst_pcie_1_axi_aclk/slowest_sync_clk] [get_bd_pins xdma_1/axi_aclk]
  connect_bd_net -net xdma_1_axi_aresetn [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins periph_intercon_1/ARESETN] [get_bd_pins periph_intercon_1/M00_ARESETN] [get_bd_pins xdma_1/axi_aresetn]
  connect_bd_net -net xdma_1_axi_ctl_aresetn [get_bd_pins periph_intercon_1/M01_ARESETN] [get_bd_pins rst_pcie_1_axi_aclk/ext_reset_in] [get_bd_pins xdma_1/axi_ctl_aresetn]
  connect_bd_net -net xdma_1_interrupt_out [get_bd_pins concat_interrupts/In1] [get_bd_pins xdma_1/interrupt_out]
  connect_bd_net -net xdma_1_interrupt_out_msi_vec0to31 [get_bd_pins concat_interrupts/In4] [get_bd_pins xdma_1/interrupt_out_msi_vec0to31]
  connect_bd_net -net xdma_1_interrupt_out_msi_vec32to63 [get_bd_pins concat_interrupts/In5] [get_bd_pins xdma_1/interrupt_out_msi_vec32to63]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins periph_intercon_0/S00_ACLK] [get_bd_pins periph_intercon_1/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins sw_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces xdma_1/M_AXI_B] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces xdma_1/M_AXI_B] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces xdma_1/M_AXI_B] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  ...
  assign_bd_address -offset 0x001100000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ddr4_1/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  ...
  assign_bd_address -offset 0xB0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs xdma_1/S_AXI_B/BAR0] -force
  assign_bd_address -offset 0x000500000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs xdma_1/S_AXI_LITE/CTL0] -force
